...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20230831151426_UserInterfaceModel_Added")]
    partial class UserInterfaceModel_Added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Models.Lecturer", b =>
                {
                    ...
                    b.Property<string>("UserInterfaceUserId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("UserInterfaceUserId");
            ...
            modelBuilder.Entity("DataAccessLayer.Models.Lecturer", b =>
                {
                    b.HasOne("DataAccessLayer.Models.UserInterface", null)
                        .WithMany("Lecturers")
                        .HasForeignKey("UserInterfaceUserId");
                });
